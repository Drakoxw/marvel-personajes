      ...
      <main className="w-full h-full bg-gray-900 text-gray-300 bg-[url('/img/wallpaper.jpg')] bg-cover bg-fixed bg-center py-8 px-12">
        ...
        <section className="mt-4">
          ...
          <div className="w-full justify-center items-center mt-6 text-amber-500 flex gap-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
              <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
            </svg>

            <span className="font-bold text-2xl">{data.length > 0 ? data.length/5 : 0}</span>

            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
